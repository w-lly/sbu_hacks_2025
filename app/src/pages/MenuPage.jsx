...
export const MenuPage = () => {
  ...
  return (
    <div className={`h-screen flex ${t.text}`}>
      ...
      <div 
        className={`${showSplitView && !splitViewFullscreen ? 'w-full md:w-1/3 p-4 sm:p-6 md:p-8' : 'w-full p-0'} 
              ...
              return (
                <div key={idx} className="relative group">
                  <button
                    ...
                    className={`w-full ${t.card} border border-themeaccent p-6 sm:p-8 rounded-2xl hover:shadow-2xl 
                      transition-all duration-300 flex flex-col items-center gap-3 sm:gap-4
                      hover:scale-105 ${selectedMenuItem?.label === item.label ? 'ring-4 ring-themeprimary' : ''}`}
                  >
                    <div
